...
//        CCActionInterval *actionTo = CCJumpTo::create(5.0f,
//                                                      CCPointMake(oldManSprite->getPosition().x, oldManSprite->getPosition().y),
//                                                      50.0f, 5);
//        CCActionInterval *actionBy = CCJumpBy::create(5.0f,
//                                                      CCPointMake(-100.0f, 100.0f),
//                                                      50.0f, 5);
//        CCActionInterval *actionBack = actionBy->reverse();
         CCSize size = CCDirector::sharedDirector()->getWinSize();
        CCActionInterval* actionMoveTo = CCMoveTo::create(2,ccp(size.width/2,size.height/2) );
       
        runAction(CCSequence::create(actionMoveTo, NULL));
        isMoving = true;
