...
- (void)createPickerView {
    ...
    if (!self.picker_wheel_left) {
        self.picker_wheel_left=[UIImage imageNamed:@"wheel_left.png"];
    }
    if (!self.picker_wheel_right) {
        self.picker_wheel_right=[UIImage imageNamed:@"wheel_right.png"];
    }
    if (!self.picker_wheel_center) {
        self.picker_wheel_center=[UIImage imageNamed:@"wheel_center.png"];
    }
    if (!self.picker_wheel_seperated_line) {
        self.picker_wheel_seperated_line=[UIImage imageNamed:@"wheel_seperated_line.png"];
    }
    if (!self.picker_selection_left) {
        self.picker_selection_left=[UIImage imageNamed:@"selection_left.png"];
    }
    if (!self.picker_selection_right) {
        self.picker_selection_right=[UIImage imageNamed:@"selection_right.png"];
    }
    if (!self.picker_selection_center) {
        self.picker_selection_center=[UIImage imageNamed:@"selection_center.png"];
    }
...
- (void)_setSelectionArea {
    ...
    CGFloat selectionY=rowHeight*_selectionPosition+WHEEL_SPACE+5;
    //左侧
