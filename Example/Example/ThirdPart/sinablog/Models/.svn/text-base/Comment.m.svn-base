...
@synthesize commentId, commentKey, text, createdAt, source, sourceUrl, favorited, truncated, user, status, replyComment,textSize;

- (Comment*)initCommentWithJsonDictionary:(NSDictionary*)dic {
...
+ (Comment*)commentWithJsonDictionary:(NSDictionary*)dic {
	return [[[Comment alloc] initCommentWithJsonDictionary:dic] autorelease];
}
