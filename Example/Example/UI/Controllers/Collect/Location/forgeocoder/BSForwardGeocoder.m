...
//							 useHTTP ? @"http" : @"https", [searchQuery URLEncodedString]];
        //maps.googleapis.com/maps/api/geocode/json?latlng=40.714224,-73.961452&sensor=true_or_false
        NSString* mapsUrl = [[NSString alloc] initWithFormat:@"%@://maps.google.com/maps/api/geocode/xml?latlng=39.910093,116.403945&language=zh-CN&sensor=false", 
                             							 useHTTP ? @"http" : @"https"];
