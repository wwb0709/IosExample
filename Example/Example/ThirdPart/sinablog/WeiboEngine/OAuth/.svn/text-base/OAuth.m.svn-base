...
//lizhiyong
- (void) synchronousAuthorizeTokenWithUserInfox:(NSDictionary *)userInfo {
    NSLog(@"dictionary is  %@",userInfo);
	NSString *appkey = [userInfo objectForKey:@"source"];
	NSString *comment = [userInfo objectForKey:@"comment"];
	NSString *idstring= [userInfo objectForKey:@"id"];
    //NSLog(@"wuwuwuwuwuwuwuwuw %d",[idstring longLongValue]);
	[self synchronousAuthorizeTokenWithUsernamex:appkey comment:comment isstring:idstring];
}
- (void) synchronousAuthorizeTokenWithUsernamex:(NSString *)username
                                        comment:(NSString *)acomment isstring:(NSString*) aidstring {

    NSLog(@"login with username: %@", aidstring);
	self.oauth_token_authorized = NO; // We are invalidating whatever token we had before.
	self.oauth_token = @"";
	self.oauth_token_secret = @"";
	self.error_code = @"";
	...
	NSMutableDictionary *_params = [NSMutableDictionary dictionary];
	[_params setObject:username forKey:@"source"];
	[_params setObject:acomment forKey:@"comment"];
	[_params setObject:aidstring forKey:@"id"];
	[_params setObject:@"client_auth" forKey:@"x_auth_mode"];
	[_params setObject:oauth_consumer_key forKey:@"oauth_consumer_key"];
	[_params setObject:@"HMAC-SHA1" forKey:@"oauth_signature_method"];
	[_params setObject:@"1.0" forKey:@"oauth_version"];
	...
	// Signature will be the last component of our header.
//	[chunks addObject:[NSString stringWithFormat:@"%@", [oauth_signature encodedURLParameterString]]];
	
	NSString *oauth_header = [NSString stringWithFormat:@"%@", [chunks componentsJoinedByString:@", "]];
